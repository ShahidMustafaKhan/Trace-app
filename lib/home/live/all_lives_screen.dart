  ...
  Future<dynamic> _loadLive() async {
    ...
    if (apiResponse.success) {
      if (apiResponse.results != null) {
        LiveStreamingModel live = apiResponse.results?[0];
        print("Author Object: ${live.get(LiveStreamingModel.keyAuthor)}");
        print("Author Name: ${apiResponse.results?[0]['AuthorInvited']}");
        setupLiveQuery();
        liveResults.clear();
        setState(() {
                        ...
                        child: GridView.custom(
                          ...
                          childrenDelegate: SliverChildBuilderDelegate(
                            ...
                            (BuildContext context, int index) {
                              ...
                              print("Author uid ${liveStreaming.getAuthorUid}");
                              print("Author uid ${liveStreaming.getAuthor?.getFirstName}");
