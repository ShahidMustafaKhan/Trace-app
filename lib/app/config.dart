...
class Config {
  ...
  static const String packageNameAndroid = "com.live.tiqtop";
  static const String packageNameiOS = "com.live.tiqtop";
  static const String iosAppStoreId = "1048";
  static final String appName = "TiqTop";
  ...
  static final String liveQueryUrl = "wss://tiqtop.b4a.io";
  static final String appId = "klgSUOauvy2SerQ8nuRCU21EvQlcpac5qVTohWZ3";
  static final String clientKey = "wUTefYv9For4QXGc8SansdnpD6LHbgnWZUlBT3ld";

  //OneSignal
  static final String oneSignalAppId = "";

  // Firebase Cloud Messaging
  static final String pushGcm = "197107529392";
  static final String webPushCertificate = "BJrax366bZq9NPRapD2Hj-ivyagQD1eFbmX3wnQ7eAncx2oO5ns1RUwXYfsSrjRwI87c3BhX-xLSXULfbF_dz5w";
